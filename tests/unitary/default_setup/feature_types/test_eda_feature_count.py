...
class TestEDAFeatureCount(TestCase):
    ...
    data = {
        ...
        "col4": ["ab", "te", "ui", "kl", "tr", "uy", "iu", "mi", "uy", "pa", "pp", "we", "ii", "bt", "gg", "tl", "mn",
                 "lo", "qa", "by"],
        "col5": ["x", "y", "y", "x", "y", "x", "x", "x", "y", "y", "x", "x", "x", "x", "x", "y", "x", "x", "x", "y"],
        "col6": np.random.default_rng().uniform(low=1, high=98, size=20),
        "col7": np.random.randint(10, size=20),
        "col8": 100 * np.random.rand(20) + 10,
        "col9": ["A10", "K19", "M89", "L55", "O99", "S34", "G77", "S34", "M65", "S34", "P87", "V47", "L82", "S34",
                 "S34", "K19", "A10", "L38", "Q88", "A10"],
    }
