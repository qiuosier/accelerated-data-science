...
class TestMLJobBackend:
    ...
    def config(self):
        return {
            ...
            "infrastructure": {
                "compartment_id": "ocid1.compartment.oc1..aaaaaaaavhk476fk2ijf3kea3443a3tuxvu7i573iwlbncri2an6pfhz5kzq",
                "project_id": "ocid1.datascienceproject.oc1.iad.amaaaaaay75uckqaxsinaibpjagdgrqlradcfpotbh3uop3wmutortg7iw7a",
                "subnet_id": "ocid1.subnet.oc1.iad.aaaaaaaayxzy4wxxdv3d5i43l4giyuysflsoyccgci6xvmf7w77netac6x4q",
                "log_group_id": "ocid1.loggroup.oc1.iad.amaaaaaay75uckqa6jracpad2ochk323h7e4f766kpisycjinbj6hacka7mq",
                "log_id": "ocid1.log.oc1.iad.amaaaaaay75uckqa6nd7s2ecxf5olz5wp6rj2pfsserhgp2kxnq2xpqyyf7a",
