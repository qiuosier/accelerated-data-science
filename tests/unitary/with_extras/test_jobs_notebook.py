...
class NotebookDriverLocalTest(NotebookDriverRunTest):
    ...
    def test_run_notebook_with_exclude_tags(self):
        ...
        notebook_path = os.path.join(
            ...
            "test_files/exclude_check.ipynb",
        )
    ...
    def test_copy_output_calls(self):
        ...
        notebook_path = os.path.join(
            os.path.dirname(__file__),
            "../default_setup/jobs/test_files/job_notebooks/notebook_with_error.ipynb",
        )
        ...
        self.assertIn("Invalid OUTPUT_URI: oci://path/to/output", outputs)
